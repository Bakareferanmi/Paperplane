...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Ds7q-3AR.mjs");
...
var manifest = {
	"4b5c59e62ec1e6c360df8afb98a0a1a36445200e5ab2fe834f5f8beee0c20917": {
		functionName: "listSubmissionFiles_createServerFn_handler",
		importer: () => import("./submissions-BN5k0OXD.mjs")
	},
	"84b3b7d63ac2def7b71fe0933dfb2da337d217c7244ed47beae0915dc0c9c7f3": {
		functionName: "getSubmissionFile_createServerFn_handler",
		importer: () => import("./submissions-BN5k0OXD.mjs")
	},
	"8e3564409c62ec723e577c7bad454f0935d5006f3e641ceeb92224f07554af91": {
		functionName: "listSubmissions_createServerFn_handler",
		importer: () => import("./submissions-BN5k0OXD.mjs")
	},
	"ae516e6c0c54e63d74872de355a42442ecedd16a0a054f49e1ea2cd5b721d405": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CRwL-tB1.mjs").then((n) => n.t),
